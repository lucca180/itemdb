...
const ItemCtxMenuV2 = (props: Props) => {
  ...
  const findAt = useMemo(() => getItemFindAtLinksV2(props.item), [props.item]);
    ...
    <>
      ...
      >
        ...
        <CtxSubmenu title={t('General.search-at')}>
          <FindAtCtx findAt={findAt} />
        </CtxSubmenu>
        <Separator />
        <CtxMenuItem onClick={() => handleCopy(item.image.url)}>
...
const FindAtCtx = (props: FindAtCtxProps) => {
  ...
  return (
    <>
      {findAt.shopWizard && (
        <CtxMenuItem onClick={() => openNewTab(findAt.shopWizard)}>
          <HStack>
            <Image
              src={SWIcon}
              alt="Shop Wizard"
      ...
      {findAt.auction && (
        <CtxMenuItem onClick={() => openNewTab(findAt.auction)}>
          <HStack>
            <Image
              src={AuctionIcon}
              alt="Auction House"
      ...
      {findAt.trading && (
        <CtxMenuItem onClick={() => openNewTab(findAt.trading)}>
          <HStack>
      ...
      {findAt.safetyDeposit && (
        <CtxMenuItem onClick={() => openNewTab(findAt.safetyDeposit)}>
          <HStack>
            <Image
              src={SDBIcon}
      ...
      {findAt.closet && (
        <CtxMenuItem onClick={() => openNewTab(findAt.closet)}>
          <HStack>
      ...
      {findAt.restockShop && (
        <CtxMenuItem onClick={() => openNewTab(findAt.restockShop)}>
          <HStack>
            <Image
              src={ShopIcon}
              alt="Restock Shop"
      ...
      {findAt.neosearch && (
        <CtxMenuItem onClick={() => openNewTab(findAt.neosearch)}>
          <HStack>
            <Image
              src={NeosearchIcon}
              alt="Neopets Search"
