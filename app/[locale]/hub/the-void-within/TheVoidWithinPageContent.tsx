...
type TheVoidWithinPageContentProps = {
  lists: UserList[];
};

export function TheVoidWithinPageContent({ lists }: TheVoidWithinPageContentProps) {
  const listGroups = lists.reduce((groups: Record<string, UserList[]>, list) => {
