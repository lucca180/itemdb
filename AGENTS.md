...
- NEVER perform any database actions such as INSERT, UPDATE, DELETE... When dealing with database you are ALWAYS a "read-only" agent. You can only read data from the database, never write or modify it.
